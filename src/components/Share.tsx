...
const START_DATE = DateTime.fromISO("2022-03-24");
...
export function Share({
  ...
  const shareText = useMemo(() => {
    ...
    const title = `#Statele #${dayCount} ${guessCount}/6 ${bestPercent}${difficultyModifierEmoji}`;
    ...
    return [title, guessString, "https://outflux.net/statele/"].join("\n");
